...
function interpolateUrl(str, data) {
  ...
  var result = str.replace(interpolationRegexp, function(match, key) {
    ...
    var _iterator = _createForOfIteratorHelper(segments), _step;
    try {
...
if (!fetchApi && !XmlHttpRequestApi && !ActiveXObjectApi) {
  try {
    import("./browser-ponyfill-4A4ZT7I6.js").then(function(mod) {
...
var addQueryString = function addQueryString2(url, params) {
  if (params && _typeof2(params) === "object") {
    ...
    for (var _i = 0, _Object$keys = Object.keys(params); _i < _Object$keys.length; _i++) {
      ...
      if (UNSAFE_KEYS2.indexOf(paramName) > -1) continue;
  ...
  try {
    ...
    if (h) {
      for (var _i2 = 0, _Object$keys2 = Object.keys(h); _i2 < _Object$keys2.length; _i2++) {
        ...
        if (UNSAFE_KEYS2.indexOf(i) > -1) continue;
