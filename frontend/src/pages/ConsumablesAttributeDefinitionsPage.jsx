        ...
        <div className="page-container" style={{ padding: 'var(--space-6)', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            <div className="page-header" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 'var(--space-8)' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-4)' }}>
                    ...
                    <div>
                        <h1 className="page-title" style={{ fontSize: 'var(--font-size-3xl)', marginBottom: 'var(--space-2)', display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}><Settings2 size={22} style={{ color: 'var(--color-accent-primary)' }} />{t('consumablesAttributeDefinitions.title')}</h1>
                    ...
                    {loading ? (
                        ...
                        <div style={{ padding: 'var(--space-2)' }}>
                            {attributeDefinitions.map((def, index) => (
                                <div
                                    key={def.consumable_attribute_definition_id}
                                    style={{
                                        display: 'flex',
                                        justifyContent: 'space-between',
                                        alignItems: 'center',
...
export default ConsumablesAttributeDefinitionsPage;
