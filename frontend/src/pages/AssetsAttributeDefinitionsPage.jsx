...
const AssetsAttributeDefinitionsPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            setEditingId(null);
            setShowForm(false);
            showSuccess(editingId ? t('assetsAttributeDefinitions.updateSuccess', 'Attribute definition updated successfully') : t('assetsAttributeDefinitions.createSuccess', 'Attribute definition created successfully'));
            await fetchAttributeDefinitions();
        } catch (err) {
            showError(t('assetsAttributeDefinitions.createError') + ': ' + err.message);
        } finally {
            setSaving(false);
        }
    };
