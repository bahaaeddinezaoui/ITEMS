...
const ConsumablesTypesPage = () => {
    ...
    return (
        <div className="page-container" style={{ padding: 'var(--space-6)', maxWidth: '1400px', margin: '0 auto' }}>
                ...
                <div className="modal-overlay" onClick={() => { if (!showAddTypeAttributeForm) setShowAttributesModal(false); }}>
                    <div className="modal" style={{ maxWidth: '700px', maxHeight: '85vh', overflow: 'hidden', display: 'flex', flexDirection: 'column' }} onClick={(e) => e.stopPropagation()}>
                        ...
                        <div className="modal-body" style={{ flex: 1, overflow: 'auto', padding: 'var(--space-5)' }}>
                            ...
                            >
                                <Plus size={18} />
                                <span>{t('consumablesTypes.addNewAttribute', 'Add New Attribute')}</span>
                            </button>
            ...
            {showAddTypeAttributeForm && selectedConsumableType && (
                <ModalPortal>
                    ...
                    <div className="modal" style={{ maxWidth: '500px' }} onClick={(e) => e.stopPropagation()}>
                        <div className="modal-header">
                            <div style={{ display: 'flex', alignItems: 'center', gap: 'var(--space-3)' }}>
                                ...
                                <h2 className="modal-title" style={{ margin: 0 }}>{t('consumablesTypes.newAttribute', 'New Attribute')}</h2>
                            </div>
                        ...
                        <div className="modal-body">
                            ...
                            <form onSubmit={handleAddTypeAttributeSubmit} className="form">
                                <div className="form-group" style={{ marginBottom: 'var(--space-4)' }}>
                                    <label className="form-label" style={{ fontWeight: '600', marginBottom: 'var(--space-2)' }}>{t('consumablesTypes.attributeDefinition', 'Attribute Definition')}</label>
                                    <select
                                        ...
                                        style={{ height: '44px' }}
                                    >
                                        <option value="">{t('consumablesTypes.selectDefinition', 'Select a definition...')}</option>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '2fr 1fr', gap: 'var(--space-4)', marginBottom: 'var(--space-4)' }}>
                                    <div className="form-group">
                                        <label className="form-label" style={{ fontWeight: '600', marginBottom: 'var(--space-2)' }}>{t('consumablesTypes.defaultValue', 'Default Value')}</label>
                                        <input
                                            type="text"
                                            name="default_value"
                                            placeholder={t('consumablesTypes.defaultValuePlaceholder', 'Enter default value (optional)')}
                                    ...
                                    <div className="form-group" style={{ display: 'flex', alignItems: 'flex-end' }}>
                                        <label style={{ 
                                            ...
                                            />
                                            <span style={{ fontSize: 'var(--font-size-sm)', fontWeight: '500' }}>{t('common.mandatory', 'Mandatory')}</span>
                                        </label>
                                    </div>
                                </div>

                                <div className="modal-footer" style={{ padding: 'var(--space-4) 0 0', border: 'none' }}>
                                    <button type="button" onClick={() => setShowAddTypeAttributeForm(false)} className="btn btn-secondary">{t('common.cancel', 'Cancel')}</button>
                                    <button type="submit" disabled={saving} className="btn btn-primary">
                                        {saving ? t('common.saving', 'Saving...') : t('consumablesTypes.saveAttribute', 'Save Attribute')}
                                    </button>
                                </div>
                            </form>
                        </div>
            ...
            <FilterSortFAB hasActiveFilters={!!searchTerm}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                    <div style={{ position: 'relative' }}>
                        ...
                        <input type="text" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} placeholder={t('consumablesTypes.searchPlaceholder')} className="form-input" style={{ width: '100%', height: '40px', paddingLeft: 'var(--space-10)', paddingRight: searchTerm ? 'var(--space-10)' : 'var(--space-4)' }} />
                        {searchTerm && (
