            ...
            <FilterSortFAB hasActiveFilters={!!searchTerm || !!statusFilter || sortField !== 'brand_name' || sortDirection !== 'asc'}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                    <div style={{ position: 'relative' }}>
                        ...
                        <input type="text" placeholder={t('stockItemBrands.searchPlaceholder', 'Search brands...')} className="form-input" value={searchTerm} onChange={(e) => setSearchTerm(e.target.value)} style={{ paddingLeft: 'var(--space-10)', height: '40px', background: 'var(--color-bg-card)', width: '100%' }} />
                    </div>
                    <div>
                        <label className="form-label" style={{ marginBottom: 'var(--space-1)' }}>{t('stockItemBrands.allStatuses', 'All Statuses')}</label>
