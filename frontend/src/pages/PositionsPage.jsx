...
const PositionsPage = () => {
    ...
    return (
        <div className="page-container" style={{ padding: 'var(--space-6)', maxWidth: '1200px', margin: '0 auto' }}>
            ...
            />
            <FilterSortFAB hasActiveFilters={!!searchQuery.trim() || sortField !== 'label' || sortDirection !== 'asc'}>
                <div style={{ display: 'flex', flexDirection: 'column', gap: 'var(--space-4)' }}>
                    <div style={{ position: 'relative' }}>
                        ...
                        <input type="text" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} placeholder={t('positions.searchPlaceholder')} className="form-input" style={{ width: '100%', height: '40px', paddingLeft: 'var(--space-10)', paddingRight: searchQuery ? 'var(--space-10)' : 'var(--space-4)' }} />
                        {searchQuery && (
                    ...
                    <div>
                        ...
                        <div style={{ display: 'flex', gap: 'var(--space-2)' }}>
                            <select className="form-input" value={sortField} onChange={(e) => setSortField(e.target.value)} style={{ height: '40px', flex: 1 }}>
                                <option value="label">{t('positions.sortByLabel')}</option>
                                <option value="code">{t('positions.sortByCode')}</option>
                                <option value="roles">{t('positions.sortByRoles')}</option>
                            </select>
