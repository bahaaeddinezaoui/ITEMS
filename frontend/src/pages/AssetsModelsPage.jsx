...
import { assetAttributeDefinitionService, assetBrandService, assetModelAttributeService, assetModelService, assetTypeService } from '../services/api';
...
const AssetsModelsPage = () => {
    ...
    const handleModelSubmit = async (e) => {
        ...
        try {
            ...
            setError('Failed to create asset model: ' + (err.response?.data?.error || err.message));
        } finally {
                ...
                <div className="card" style={{ overflow: 'hidden', display: 'flex', flexDirection: 'column' }}>
                    <div className="card-header" style={{
                        ...
                        <h2 style={{ fontSize: 'var(--font-size-md)', fontWeight: '600', margin: 0 }}>
                            Model Attributes {selectedAssetModel ? `• ${selectedAssetModel.model_name}` : ''}
                        </h2>
                        <button
