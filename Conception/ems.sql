/*==============================================================*/
/* DBMS name:      MySQL 5.0                                    */
/* Created on:     2/7/2026 3:51:08 PM                          */
/*==============================================================*/
...
alter table AO_IS_LINKED_TO_RR 
   drop foreign key FK_AO_IS_LI_AO_IS_LIN_RECEIPT_;

alter table AO_IS_LINKED_TO_RR 
   drop foreign key FK_AO_IS_LI_AO_IS_LIN_ATTRIBUT;
...
alter table ASSET_IS_COMPOSED_OF_STOCK_ITEMS_HISTORY 
   drop foreign key FK_ASSET_IS_ASSET_IS__ASSET_BR;
...
alter table ASSET_MOVEMENT 
   drop foreign key FK_ASSET_MO_ASSET_MOV_ROOM;
...
alter table COMPANY_ASSET_REQUEST_IS_LINKED_TO_RECEIPT_REPORT 
   drop foreign key FK_COMPANY__COMPANY_A_COMPANY_;

alter table COMPANY_ASSET_REQUEST_IS_LINKED_TO_RECEIPT_REPORT 
   drop foreign key FK_COMPANY__COMPANY_A_RECEIPT_;
...
alter table CONSUMABLE_IS_ASSIGNED_TO_PERSON 
   drop foreign key FK_CONSUMAB_CONSUMABL_PERSON;
...
alter table CONSUMABLE_MOVEMENT 
   drop foreign key FK_CONSUMAB_CONSUMABL_ROOM;
...
alter table STOCK_ITEM_IS_ASSIGNED_TO_PERSON 
   drop foreign key FK_STOCK_IT_STOCK_ITE_PERSON;
...
drop table if exists AO_IS_LINKED_TO_RR;
...
drop table if exists COMPANY_ASSET_REQUEST_IS_LINKED_TO_RECEIPT_REPORT;
...
drop table if exists POSITION_ROLE_MAPPING;
...
drop table if exists SUPERUSER_CREATES_ACCOUNT;
...
drop table if exists SUPERUSER_MODIFIES_ACCOUNT;
...
/*==============================================================*/
create table AO_IS_LINKED_TO_RR
(
   ATTRIBUTION_ORDER_ID int not null  comment '',
   RECEIPT_REPORT_ID    int not null  comment '',
   primary key (ATTRIBUTION_ORDER_ID, RECEIPT_REPORT_ID)
);
...
(
   ...
   START_DATETIME       datetime  comment '',
   END_DATETIME         datetime  comment '',
   primary key (STOCK_ITEM_ID, ASSET_BRAND_ID, MAINTENANCE_STEP_ID)
);
...
(
   ...
   CORPSE_DESIGNATION   varchar(60)  comment '',
   REGISTER_NUMBER_OR_BOOK_JOURNAL_OF_CORPSE varchar(60)  comment '',
   REGRSTER_NUMBER_OR_BOOK_JOURNAL_OF_ESTABLISHMENT varchar(60)  comment '',
...
alter table COMPANY_ASSET_REQUEST comment 'Demande du matériel';

/*==============================================================*/
/* Table: COMPANY_ASSET_REQUEST_IS_LINKED_TO_RECEIPT_REPORT     */
/*==============================================================*/
create table COMPANY_ASSET_REQUEST_IS_LINKED_TO_RECEIPT_REPORT
(
   RECEIPT_REPORT_ID    int not null  comment '',
   COMPANY_ASSET_REQUEST_ID int not null  comment '',
   primary key (RECEIPT_REPORT_ID, COMPANY_ASSET_REQUEST_ID)
);
...
(
   ...
   CONDITION_ON_ASSIGNMENT varchar(48) not null  comment '',
   IS_ACTIVE            bool not null  comment '',
   primary key (ASSIGNED_BY_PERSON_ID)
);
...
(
   ...
   ITEM_SENT_TO_EXTERNAM_MAINTENANCE_DATETIME datetime  comment '',
...
(
   ...
   APPROVED_BY_MAINTENACE_CHIEF_ID int not null  comment '',
...
alter table RECEIPT_REPORT comment 'This represents the "PV de réception"';
...
/*==============================================================*/
create table SUPERUSER_CREATES_ACCOUNT
(
   OWNER_USER_ID        int not null  comment '',
   CREATOR_USER_ID      int not null  comment '',
   primary key (OWNER_USER_ID, CREATOR_USER_ID)
);

alter table SUPERUSER_CREATES_ACCOUNT comment 'This will generate a FK, which should be called "created_by_';

/*==============================================================*/
/* Table: SUPERUSER_MODIFIES_ACCOUNT                            */
/*==============================================================*/
create table SUPERUSER_MODIFIES_ACCOUNT
(
   USER_ID              int not null  comment '',
   MODIFIER_USER_ID     int not null  comment '',
   primary key (USER_ID, MODIFIER_USER_ID)
);

alter table SUPERUSER_MODIFIES_ACCOUNT comment 'This will generate a FK, which should be called "modified_by';
...
alter table AO_IS_LINKED_TO_RR add constraint FK_AO_IS_LI_AO_IS_LIN_RECEIPT_ foreign key (RECEIPT_REPORT_ID)
      references RECEIPT_REPORT (RECEIPT_REPORT_ID) on delete restrict on update restrict;

alter table AO_IS_LINKED_TO_RR add constraint FK_AO_IS_LI_AO_IS_LIN_ATTRIBUT foreign key (ATTRIBUTION_ORDER_ID)
      references ATTRIBUTION_ORDER (ATTRIBUTION_ORDER_ID) on delete restrict on update restrict;
...
alter table ASSET_IS_ASSIGNED_TO_PERSON add constraint FK_ASSET_IS_ASSET_IS__PERSON foreign key (ASSIGNED_BY_PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table ASSET_IS_ASSIGNED_TO_PERSON add constraint FK_ASSET_IS_ASSET_IS__PERSON foreign key (PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table ASSET_IS_ASSIGNED_TO_PERSON add constraint FK_ASSET_IS_ASSET_IS__ASSET foreign key (ASSET_ID)
      references ASSET (ASSET_ID) on delete restrict on update restrict;

alter table ASSET_IS_COMPOSED_OF_CONSUMABLE_HISTORY add constraint FK_ASSET_IS_ASSET_IS__ASSET foreign key (ASSET_ID)
      references ASSET (ASSET_ID) on delete restrict on update restrict;
...
alter table ASSET_IS_COMPOSED_OF_CONSUMABLE_HISTORY add constraint FK_ASSET_IS_ASSET_IS__MAINTENA foreign key (MAINTENANCE_STEP_ID)
      references MAINTENANCE_STEP (MAINTENANCE_STEP_ID) on delete restrict on update restrict;

alter table ASSET_IS_COMPOSED_OF_STOCK_ITEMS_HISTORY add constraint FK_ASSET_IS_ASSET_IS__MAINTENA foreign key (MAINTENANCE_STEP_ID)
      references MAINTENANCE_STEP (MAINTENANCE_STEP_ID) on delete restrict on update restrict;

alter table ASSET_IS_COMPOSED_OF_STOCK_ITEMS_HISTORY add constraint FK_ASSET_IS_ASSET_IS__ASSET_BR foreign key (ASSET_BRAND_ID)
...
alter table ASSET_MOVEMENT add constraint FK_ASSET_MO_ASSET_MOV_ROOM foreign key (SOURCE_ROOM_ID)
      references ROOM (ROOM_ID) on delete restrict on update restrict;

alter table ASSET_MOVEMENT add constraint FK_ASSET_MO_ASSET_MOV_ROOM foreign key (DESTINATION_ROOM_ID)
      references ROOM (ROOM_ID) on delete restrict on update restrict;
...
alter table COMPANY_ASSET_REQUEST_IS_LINKED_TO_RECEIPT_REPORT add constraint FK_COMPANY__COMPANY_A_COMPANY_ foreign key (COMPANY_ASSET_REQUEST_ID)
      references COMPANY_ASSET_REQUEST (COMPANY_ASSET_REQUEST_ID) on delete restrict on update restrict;

alter table COMPANY_ASSET_REQUEST_IS_LINKED_TO_RECEIPT_REPORT add constraint FK_COMPANY__COMPANY_A_RECEIPT_ foreign key (RECEIPT_REPORT_ID)
      references RECEIPT_REPORT (RECEIPT_REPORT_ID) on delete restrict on update restrict;

alter table CONSUMABLE add constraint FK_CONSUMAB_CONSUMABL_DESTRUCT foreign key (DESTRUCTION_CERTIFICATE_ID)
      references DESTRUCTION_CERTIFICATE (DESTRUCTION_CERTIFICATE_ID) on delete restrict on update restrict;

alter table CONSUMABLE add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_MODEL_ID)
      references CONSUMABLE_MODEL (CONSUMABLE_MODEL_ID) on delete restrict on update restrict;

alter table CONSUMABLE_ATTRIBUTE_VALUE add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_ATTRIBUTE_DEFINITION_ID)
      references CONSUMABLE_ATTRIBUTE_DEFINITION (CONSUMABLE_ATTRIBUTE_DEFINITION_ID) on delete restrict on update restrict;

alter table CONSUMABLE_ATTRIBUTE_VALUE add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_ID)
      references CONSUMABLE (CONSUMABLE_ID) on delete restrict on update restrict;
...
alter table CONSUMABLE_CONDITION_HISTORY_HAS_PHYSICAL_CONDITION add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_CONDITION_HISTORY_ID)
      references CONSUMABLE_CONDITION_HISTORY (CONSUMABLE_CONDITION_HISTORY_ID) on delete restrict on update restrict;

alter table CONSUMABLE_IS_ASSIGNED_TO_PERSON add constraint FK_CONSUMAB_CONSUMABL_PERSON foreign key (ASSIGNED_BY_PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table CONSUMABLE_IS_ASSIGNED_TO_PERSON add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_ID)
      references CONSUMABLE (CONSUMABLE_ID) on delete restrict on update restrict;

alter table CONSUMABLE_IS_ASSIGNED_TO_PERSON add constraint FK_CONSUMAB_CONSUMABL_PERSON foreign key (PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table CONSUMABLE_IS_USED_IN_STOCK_ITEM_HISTORY add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_ID)
      references CONSUMABLE (CONSUMABLE_ID) on delete restrict on update restrict;

alter table CONSUMABLE_IS_USED_IN_STOCK_ITEM_HISTORY add constraint FK_CONSUMAB_CONSUMABL_MAINTENA foreign key (MAINTENANCE_STEP_ID)
      references MAINTENANCE_STEP (MAINTENANCE_STEP_ID) on delete restrict on update restrict;
...
alter table CONSUMABLE_MODEL add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_BRAND_ID)
      references CONSUMABLE_BRAND (CONSUMABLE_BRAND_ID) on delete restrict on update restrict;

alter table CONSUMABLE_MODEL add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_TYPE_ID)
      references CONSUMABLE_TYPE (CONSUMABLE_TYPE_ID) on delete restrict on update restrict;

alter table CONSUMABLE_MODEL_ATTRIBUTE_VALUE add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_ATTRIBUTE_DEFINITION_ID)
      references CONSUMABLE_ATTRIBUTE_DEFINITION (CONSUMABLE_ATTRIBUTE_DEFINITION_ID) on delete restrict on update restrict;

alter table CONSUMABLE_MODEL_ATTRIBUTE_VALUE add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_MODEL_ID)
      references CONSUMABLE_MODEL (CONSUMABLE_MODEL_ID) on delete restrict on update restrict;
...
alter table CONSUMABLE_MODEL_IS_FOUND_IN_BDC add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_MODEL_ID)
      references CONSUMABLE_MODEL (CONSUMABLE_MODEL_ID) on delete restrict on update restrict;

alter table CONSUMABLE_MOVEMENT add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_ID)
      references CONSUMABLE (CONSUMABLE_ID) on delete restrict on update restrict;

alter table CONSUMABLE_MOVEMENT add constraint FK_CONSUMAB_CONSUMABL_ROOM foreign key (DESTINATION_ROOM_ID)
      references ROOM (ROOM_ID) on delete restrict on update restrict;

alter table CONSUMABLE_MOVEMENT add constraint FK_CONSUMAB_CONSUMABL_ROOM foreign key (SOURCE_ROOM_ID)
      references ROOM (ROOM_ID) on delete restrict on update restrict;

alter table CONSUMABLE_MOVEMENT add constraint FK_CONSUMAB_CONSUMABL_MAINTENA foreign key (MAINTENANCE_STEP_ID)
      references MAINTENANCE_STEP (MAINTENANCE_STEP_ID) on delete restrict on update restrict;

alter table CONSUMABLE_MOVEMENT add constraint FK_CONSUMAB_CONSUMABL_EXTERNAL foreign key (EXTERNAL_MAINTENANCE_STEP_ID)
      references EXTERNAL_MAINTENANCE_STEP (EXTERNAL_MAINTENANCE_STEP_ID) on delete restrict on update restrict;

alter table CONSUMABLE_TYPE_ATTRIBUTE add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_ATTRIBUTE_DEFINITION_ID)
      references CONSUMABLE_ATTRIBUTE_DEFINITION (CONSUMABLE_ATTRIBUTE_DEFINITION_ID) on delete restrict on update restrict;

alter table CONSUMABLE_TYPE_ATTRIBUTE add constraint FK_CONSUMAB_CONSUMABL_CONSUMAB foreign key (CONSUMABLE_TYPE_ID)
      references CONSUMABLE_TYPE (CONSUMABLE_TYPE_ID) on delete restrict on update restrict;

alter table C_IS_COMPATIBLE_WITH_A add constraint FK_C_IS_COM_C_IS_COMP_ASSET_MO foreign key (ASSET_MODEL_ID)
      references ASSET_MODEL (ASSET_MODEL_ID) on delete restrict on update restrict;

alter table C_IS_COMPATIBLE_WITH_A add constraint FK_C_IS_COM_C_IS_COMP_CONSUMAB foreign key (CONSUMABLE_MODEL_ID)
      references CONSUMABLE_MODEL (CONSUMABLE_MODEL_ID) on delete restrict on update restrict;
...
alter table C_IS_COMPATIBLE_WITH_SI add constraint FK_C_IS_COM_C_IS_COMP_CONSUMAB foreign key (CONSUMABLE_MODEL_ID)
      references CONSUMABLE_MODEL (CONSUMABLE_MODEL_ID) on delete restrict on update restrict;
...
alter table EXTERNAL_MAINTENANCE_DOCUMENT add constraint FK_EXTERNAL_EXTERNAL__EXTERNAL foreign key (EXTERNAL_MAINTENANCE_ID)
...
alter table EXTERNAL_MAINTENANCE_STEP add constraint FK_EXTERNAL_EXTERNAL__EXTERNAL foreign key (EXTERNAL_MAINTENANCE_ID)
      references EXTERNAL_MAINTENANCE (EXTERNAL_MAINTENANCE_ID) on delete restrict on update restrict;

alter table EXTERNAL_MAINTENANCE_STEP add constraint FK_EXTERNAL_EXTERNAL__EXTERNAL foreign key (EXTERNAL_MAINTENANCE_PROVIDER_ID)
...
alter table MAINTENANCE add constraint FK_MAINTENA_PERSON_AS_PERSON foreign key (APPROVED_BY_MAINTENACE_CHIEF_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table MAINTENANCE add constraint FK_MAINTENA_PERSON_IS_PERSON foreign key (ASSIGNED_BY_PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;
...
alter table MAINTENANCE_INSPECTION_LEADS_TO_BROKEN_ITEM_REPORT add constraint FK_MAINTENA_MAINTENAN_MAINTENA foreign key (MAINTENANCE_ID)
      references MAINTENANCE (MAINTENANCE_ID) on delete restrict on update restrict;
...
alter table MAINTENANCE_STEP add constraint FK_MAINTENA_MAINTENAN_MAINTENA foreign key (MAINTENANCE_ID)
      references MAINTENANCE (MAINTENANCE_ID) on delete restrict on update restrict;

alter table MAINTENANCE_STEP add constraint FK_MAINTENA_MAINTENAN_MAINTENA foreign key (MAINTENANCE_TYPICAL_STEP_ID)
      references MAINTENANCE_TYPICAL_STEP (MAINTENANCE_TYPICAL_STEP_ID) on delete restrict on update restrict;

alter table MAINTENANCE_STEP add constraint FK_MAINTENA_PERSON_IS_PERSON foreign key (PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;
...
alter table ORGANIZATIONAL_STRUCTURE_RELATION add constraint FK_ORGANIZA_ORGANIZAT_ORGANIZA foreign key (PARENT_ORGANIZATIONAL_STRUCTURE_ID)
      references ORGANIZATIONAL_STRUCTURE (ORGANIZATIONAL_STRUCTURE_ID) on delete restrict on update restrict;

alter table ORGANIZATIONAL_STRUCTURE_RELATION add constraint FK_ORGANIZA_ORGANIZAT_ORGANIZA foreign key (ORGANIZATIONAL_STRUCTURE_ID)
      references ORGANIZATIONAL_STRUCTURE (ORGANIZATIONAL_STRUCTURE_ID) on delete restrict on update restrict;
...
alter table PERSON_REPORTS_PROBLEM_ON_ASSET add constraint FK_PERSON_R_PERSON_RE_PERSON foreign key (PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table PERSON_REPORTS_PROBLEM_ON_CONSUMABLE add constraint FK_PERSON_R_PERSON_RE_CONSUMAB foreign key (CONSUMABLE_ID)
      references CONSUMABLE (CONSUMABLE_ID) on delete restrict on update restrict;

alter table PERSON_REPORTS_PROBLEM_ON_CONSUMABLE add constraint FK_PERSON_R_PERSON_RE_PERSON foreign key (PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table PERSON_REPORTS_PROBLEM_ON_STOCK_ITEM add constraint FK_PERSON_R_PERSON_RE_PERSON foreign key (PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table PERSON_REPORTS_PROBLEM_ON_STOCK_ITEM add constraint FK_PERSON_R_PERSON_RE_STOCK_IT foreign key (STOCK_ITEM_ID)
      references STOCK_ITEM (STOCK_ITEM_ID) on delete restrict on update restrict;

alter table POSITION_ROLE_MAPPING add constraint FK_POSITION_POSITION__PERSON foreign key (PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table POSITION_ROLE_MAPPING add constraint FK_POSITION_POSITION__ROLE foreign key (ROLE_ID)
...
alter table STOCK_ITEM add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_MODEL_ID)
      references STOCK_ITEM_MODEL (STOCK_ITEM_MODEL_ID) on delete restrict on update restrict;

alter table STOCK_ITEM add constraint FK_STOCK_IT_STOCK_ITE_MAINTENA foreign key (MAINTENANCE_STEP_ID)
      references MAINTENANCE_STEP (MAINTENANCE_STEP_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_ATTRIBUTE_VALUE add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_ID)
      references STOCK_ITEM (STOCK_ITEM_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_ATTRIBUTE_VALUE add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_ATTRIBUTE_DEFINITION_ID)
...
alter table STOCK_ITEM_CONDITION_HISTORY add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_ID)
      references STOCK_ITEM (STOCK_ITEM_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_IS_ASSIGNED_TO_PERSON add constraint FK_STOCK_IT_STOCK_ITE_PERSON foreign key (ASSIGNED_BY_PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_IS_ASSIGNED_TO_PERSON add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_ID)
      references STOCK_ITEM (STOCK_ITEM_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_IS_ASSIGNED_TO_PERSON add constraint FK_STOCK_IT_STOCK_ITE_PERSON foreign key (PERSON_ID)
      references PERSON (PERSON_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_IS_COMPATIBLE_WITH_ASSET add constraint FK_STOCK_IT_STOCK_ITE_ASSET_MO foreign key (ASSET_MODEL_ID)
      references ASSET_MODEL (ASSET_MODEL_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_IS_COMPATIBLE_WITH_ASSET add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_MODEL_ID)
      references STOCK_ITEM_MODEL (STOCK_ITEM_MODEL_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_MODEL add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_BRAND_ID)
      references STOCK_ITEM_BRAND (STOCK_ITEM_BRAND_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_MODEL add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_TYPE_ID)
      references STOCK_ITEM_TYPE (STOCK_ITEM_TYPE_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_MODEL_ATTRIBUTE_VALUE add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_MODEL_ID)
      references STOCK_ITEM_MODEL (STOCK_ITEM_MODEL_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_MODEL_ATTRIBUTE_VALUE add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_ATTRIBUTE_DEFINITION_ID)
      references STOCK_ITEM_ATTRIBUTE_DEFINITION (STOCK_ITEM_ATTRIBUTE_DEFINITION_ID) on delete restrict on update restrict;
...
alter table STOCK_ITEM_MODEL_IS_FOUND_IN_BDC add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_MODEL_ID)
      references STOCK_ITEM_MODEL (STOCK_ITEM_MODEL_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_MOVEMENT add constraint FK_STOCK_IT_STOCK_ITE_EXTERNAL foreign key (EXTERNAL_MAINTENANCE_STEP_ID)
      references EXTERNAL_MAINTENANCE_STEP (EXTERNAL_MAINTENANCE_STEP_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_MOVEMENT add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_ID)
      references STOCK_ITEM (STOCK_ITEM_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_MOVEMENT add constraint FK_STOCK_IT_STOCK_ITE_ROOM foreign key (SOURCE_ROOM_ID)
      references ROOM (ROOM_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_MOVEMENT add constraint FK_STOCK_IT_STOCK_ITE_ROOM foreign key (DESTINATION_ROOM_ID)
      references ROOM (ROOM_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_MOVEMENT add constraint FK_STOCK_IT_STOCK_ITE_MAINTENA foreign key (MAINTENANCE_STEP_ID)
      references MAINTENANCE_STEP (MAINTENANCE_STEP_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_TYPE_ATTRIBUTE add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_TYPE_ID)
      references STOCK_ITEM_TYPE (STOCK_ITEM_TYPE_ID) on delete restrict on update restrict;

alter table STOCK_ITEM_TYPE_ATTRIBUTE add constraint FK_STOCK_IT_STOCK_ITE_STOCK_IT foreign key (STOCK_ITEM_ATTRIBUTE_DEFINITION_ID)
      references STOCK_ITEM_ATTRIBUTE_DEFINITION (STOCK_ITEM_ATTRIBUTE_DEFINITION_ID) on delete restrict on update restrict;

alter table SUPERUSER_CREATES_ACCOUNT add constraint FK_SUPERUSE_SUPERUSER_USER_ACC foreign key (CREATOR_USER_ID)
      references USER_ACCOUNT (USER_ID) on delete restrict on update restrict;

alter table SUPERUSER_CREATES_ACCOUNT add constraint FK_SUPERUSE_SUPERUSER_USER_ACC foreign key (OWNER_USER_ID)
      references USER_ACCOUNT (USER_ID) on delete restrict on update restrict;

alter table SUPERUSER_MODIFIES_ACCOUNT add constraint FK_SUPERUSE_SUPERUSER_USER_ACC foreign key (MODIFIER_USER_ID)
      references USER_ACCOUNT (USER_ID) on delete restrict on update restrict;

alter table SUPERUSER_MODIFIES_ACCOUNT add constraint FK_SUPERUSE_SUPERUSER_USER_ACC foreign key (USER_ID)
      references USER_ACCOUNT (USER_ID) on delete restrict on update restrict;
