...
router.register(r'stock-item-model-default-consumables', StockItemModelDefaultConsumableViewSet, basename='stockitemmodeldefaultconsumable')
...
router.register(r'asset-org-assignments', AssetIsAssignedToOrgStructureViewSet, basename='assetorgassignment')
router.register(r'stock-item-org-assignments', StockItemIsAssignedToOrgStructureViewSet, basename='stockitemorgassignment')
router.register(r'consumable-org-assignments', ConsumableIsAssignedToOrgStructureViewSet, basename='consumableorgassignment')
...
router.register(r'maintenance-step-statuses', MaintenanceStepStatusViewSet, basename='maintenancestepstatus')
...
urlpatterns = [
    ...
    path('assignments/', AssignmentsListView.as_view(), name='assignments'),
